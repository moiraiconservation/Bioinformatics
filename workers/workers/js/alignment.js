...
//          Alignment.filter_hsp_array_by_characters                         //
//          Alignment.filter_hsp_array_by_expect                             //
//          Alignment.filter_hsp_array_by_nat_score                          //
//          Alignment.filter_hsp_array_by_p_value                            //
//          Alignment.filter_hsp_array_by_score                              //
...
Alignment.prototype.evaluate = function(hsp_array, query, subject, options) {
  ...
  for (let i = 0; i < subsets.length; i++) {
    if (subsets[i].length) {
      if (subsets[i].length <= options.max_hsp_number) {
  ...
  hsp_reports.sort(function(a, b) {
    if (a.expect < b.expect) { return -1; }
    if (a.expect > b.expect) { return  1; }
    if (a.expect === b.expect) {
      if (a.query_coverage > b.query_coverage) { return -1; }
      if (a.query_coverage < b.query_coverage) { return  1; }
    } // end if
    return 0;
  }); // end sort
  if (hsp_reports.length) { hsp_array = hsp_reports[0].hsp; }
  else { hsp_array = []; }
  return hsp_array;
}; // end prototype
///////////////////////////////////////////////////////////////////////////////
...
Alignment.prototype.create_hsp_report = function(hsp_array, query, subject, options) {
  ...
  // MULTIPLE HSPs ///////////////////////////////////////////////////////
    ...
    //  Guide to the Basic Local Alignment Search Tool. Pages: 69, and 105.
...
///////////////////////////////////////////////////////////////////////////////
// PROTOTYPE //////////////////////////////////////////////////////////////////
Alignment.prototype.filter_hsp_array_by_characters = function(hsp_array, threshold) {
  if (typeof(hsp_array) === 'undefined') { return []; }
  if (!Array.isArray(hsp_array)) { return []; }
  let new_hsp_array = [];
  for (let i = 0; i < hsp_array.length; i++) { if (hsp_array[i].keep) { new_hsp_array.push(hsp_array[i]); } }
...
///////////////////////////////////////////////////////////////////////////////
// PROTOTYPE //////////////////////////////////////////////////////////////////
Alignment.prototype.filter_hsp_array_by_nat_score = function(hsp_array, threshold) {
  if (typeof(hsp_array) === 'undefined') { return []; }
  if (!Array.isArray(hsp_array)) { return []; }
  let new_hsp_array = [];
  for (let i = 0; i < hsp_array.length; i++) { if (hsp_array[i].keep) { new_hsp_array.push(hsp_array[i]); } }
...
///////////////////////////////////////////////////////////////////////////////
// PROTOTYPE //////////////////////////////////////////////////////////////////
Alignment.prototype.filter_hsp_array_by_percent_identity = function(hsp_array, threshold) {
  if (typeof(hsp_array) === 'undefined') { return []; }
  if (!Array.isArray(hsp_array)) { return []; }
  let new_hsp_array = [];
  for (let i = 0; i < hsp_array.length; i++) { if (hsp_array[i].keep) { new_hsp_array.push(hsp_array[i]); } }
...
///////////////////////////////////////////////////////////////////////////////
// PROTOTYPE //////////////////////////////////////////////////////////////////
Alignment.prototype.filter_hsp_array_by_score = function(hsp_array, threshold) {
  if (typeof(hsp_array) === 'undefined') { return []; }
  if (!Array.isArray(hsp_array)) { return []; }
  let new_hsp_array = [];
  for (let i = 0; i < hsp_array.length; i++) { if (hsp_array[i].keep) { new_hsp_array.push(hsp_array[i]); } }
