///////////////////////////////////////////////////////////////////////////////
// proteome_index /////////////////////////////////////////////////////////////
//  Receives an object containing a series of protein IDs and sequences and  //
//  creates an index of corresponding kmers and protein IDs.  For this       //
//  algorithm, a kmer size of 4 is used as the default.  Smaller kmer sizes  //
...
function update_number_of_records(organism_name, num_records) {
  return new Promise(function(resolve, reject) {
    try {
      ...
      xmlhttp.open("POST", "https://www.moiraiconservation.org/workers/PHP/proteome_index", true);
...
function record_to_db(record, organism_name, index, chunk_size) {
  return new Promise(function(resolve, reject) {
    ...
    let send_message = "execute=true";
    send_message += "&command=proteome_index_to_db";
