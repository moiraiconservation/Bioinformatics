...
//      (1) Objects and functions associated with the management of multithreading.  These       //
//          include the onmessage function, and the Alignment constructor along with its two     //
//          primary methods add_job and create_worker.                                           //
//      (2) Functions associated with single-thread tasks.  These can be further divided into    //
//          (a) primary functions associated with the analysis of protein or nucleotide          //
//          sequences, and (b) secondary supporting functions that provide mathematical and      //
//          string manipulation capabilities.                                                    //
//      (3) Functions associated with multithread tasks (and which usually consist of series of  //
//          calls to single-thread tasks.                                                        //
//===============================================================================================//
//  Both, multithread functions and single-thread primary functions are expected to take the     //
//  following three arguments:                                                                   //
//      (1) query: This argument represents the protein or nucleotide sequence that is being     //
//          investigated.  Traditionally, this sequence will correspond to the i index (rows) of //
//          a scoring or dynamic programming matrix.                                             //
//      (2) subject: This argument represents a single protein or nucleotide sequence object, or //
//          an array of protein or nucleotide sequences objects.  The "subject" contains the     //
//          sequence (or sequences) that the query is being search against or aligned against,   //
//          and traditionally this will correspond to the j index (columns) of a scoring or      //
//          dynamic programming matrix. For single-thread primary functions, the subject should  //
//          consist of a single object with the proper character sequence stored in the          //
//          "sequence" element.  For multithread functions, the subject should consist of an     //
//          array of objects, each with its own sequence element.  For these functions, actions  //
//          applied to each element of the subject array will be passed to separate threads.     //
//      (3) options: This argument represents an object of Booleans, integers, and floating-     //
//          point values intended to control the operation of the function.                      //
//  Functions may also take a workerNumber argument.  This argument is used internally to manage //
//  multithreading, and should not be passed to the function by the user.                        //
//===============================================================================================//
//  THE REPORT OBJECT                                                                            //
//  Both multithread functions and single-thread primary functions are expected to return an     //
//  array consisting of one or more report objects.  Report objects may possess the folloing     //
//  elements:                                                                                    //
...
//      threshold...........The p-value significance threshold used for determining the          //
//                          statistical significance of an alignment.  This may vary based on    //
//                          the method of multiple significance testing correction used.         //
//      significant.........A Boolean indicating if the alignment is statistically significant   //
//                          (i.e., the p-value is below the threshold).                          //
//      characters..........The number of characters in the query sequence.                      //
//      identity............The number of characters in the query sequence that aligned to       //
//                          identical characters in the subject sequence.                        //
//      percent_identity....identity / characters                                                //
//      hsp_gaps............The number of gaps in the query sequence between high-scoring        //
//                          segment pairs.  This statistic is used in calculating some versions  //
//                          of a sum score.                                                      //
//      query...............The query sequence.                                                  //
//      subject.............The subject sequence.                                                //
//      hsp.................An array containing high-scoring segment pair (HSP) objects          //
//                          associated with this alignment.  (See object structure below.)       //
//      batch...............An element used to keep track of objects during multithreading.      //
//      data................The associated subject object.  Including the data element allows    //
//                          for the possibility of passing additional user-defined data in with  //
//                          the subject array argument and having that data returned by the      //
//                          function.                                                            //
//===============================================================================================//
//  THE HSP OBJECT                                                                               //
...
//      subject.............The character sequence of the subject that is within range of the    //
//                          HSP.                                                                 //
...
//      characters..........The number of characters in the query sequence within the range of   //
//                          the HSP .                                                            //
//      identity............The number of characters in the query sequence that aligned to       //
//                          identical characters in the subject sequence, within the range of    //
//                          the HSP.                                                             //
...
//      diagonal............A number indicating the specific "diagonal" that the HSP lies on.    //
//                          In this case, the "diagonal" is the diagonal path of a real or       //
//                          hypothetical dynamic programing matrix, and can be calculated as     //
//                          query_start - subject_start.                                         //
//      centroid............The central tendency of an HSP, expressed as a pair of indices (one  //
//                          for the query segment and one for the subject segment).  These value //
//                          can be calculated several different ways, including (but not limited //
//                          to) the indices of the characters midway along the length of the     //
//                          query and subject sequences within the HSP range (standard method);  //
//                          the index positions within the HSP range for which half of the score //
//                          of the HSP lies to either side (exonerate method); or the indices of //
//                          the central characters within the highest scoring eleven-character   //
//                          word hit within the HSP (X-drop).  The calculate_hsp_centroids       //
//                          function takes a "method" argument that lets the user pick the       //
//                          method for calculation.                                              //
//      centroid.query......The centroid index of the query segment.                             //
//      centroid.subject....The centroid index of the subject segment.                           //
//      extended............A Boolean indicating if the length of the HSP has been extend by one //
//                          of the HSP extension functions.                                      //
//      gapped_alignment....A Boolean indicating if this HSP is the result of an alignment that  //
//                          allows gaps.                                                         //
//      changed.............A Boolean indicating if this HSP has been altered in any way since   //
//                          the last time its statistics were calculated.                        //
//      keep................A Boolean meant for internal use.  This value is set to true by      //
//                          default, but will be set to false if the HSP has been flagged for    //
//                          removal by a filtering function.  By definition, this element should //
//                          always be set to true for any HSP returned to the user.              //
//===============================================================================================//
//  THE OPTIONS OBJECT                                                                           //
...
//      score.gap_open..............The affine gap opening penalty.  (Also called the gap        //
//                                  existence penalty.)                                          //
//      score.gap_extend. ..........The affine gap extension penalty.                            //
//      score.gapped................A Boolean value indicating if gaps are allowed within either //
//                                  an alignment or an HSP.                                      //
//      search_space.num_characters.The total number of sequence characters among all the        //
//                                  entries in a subject database.  This value is used to        //
//                                  calculate the adjusted search space (m'n').                  //
//      search_space.num_sequences..The total number of entries in the subject database.  This   //
//                                  value is used to calculate the adjusted search space (m'n'). //
//      seed.word_size..............The length in characters of the words to match between the   //
//                                  query and subject sequences.                                 //
//      seed.score_threshold........The lowest allowed score for registering a match between     //
//                                  words.                                                       //
//      seed.exact_match............A Boolean indicating if only exact word matches between the  //
//                                  query and subject sequences should be considered as hits.    //
//                                  If this option is set to true, then the word_score_threshold //
//                                  option will be ignored and all exact word matches will be    //
//                                  considered.                                                  //
//      seed.filter_low_complexity..A Boolean that indicates if low-complexity filtering should  //
//                                  be applied.                                                  //
//      seed.max_number.............The maximum number of seeds allowed between two sequences.   //
//                                  This option is provided as a safeguard to prevent extreme    //
//                                  lengths of operation time when aligning two sequences,       //
//                                  however by default this value is set very high (100 000).    //
//      x_drop.X1...................When using the ungapped local alignment X-drop algorithm,    //
//                                  this is the amount that a score is allowed to drop below the //
//                                  maximum observed score.  This value is in bits.              //
//      x_drop.X2...................When using the gapped local alignment X-drop algorithm, this //
//                                  is the amount that a score is allowed to drop below the      //
//                                  maximum observed score is allowed to drop below the maximum  //
//                                  observed score (within an antiparallel of a dynamic          //
//                                  programming matrix).  Any scores that drop below this amount //
//                                  will not be recorded. This score is given in bits.           //
//      x_drop.X2_trigger...........When score.gapped is set to true, then an HSP must have a    //
//                                  score above this trigger value (in bits) before it will be   //
//                                  evaluated by the gapped x-drop algorithm (represented here   //
//                                  by the Alignment.x_drop_extend function).                    //
//      x_drop.X3...................When using a gapped global alignment X-drop algorithm, this  //
//                                  is the amount that a score is allowed to drop below the      //
//                                  maximum observed score is allowed to drop below the maximum  //
//                                  observed score (within an antiparallel of a dynamic          //
//                                  programming matrix).  Any scores that drop below this amount //
//                                  will not be recorded. This score is given in bits.           //
//      single_hit_algorithm........A Boolean that indicates if the original single-hit BLAST    //
//                                  algorithm should be used.  If set to false, then the two-hit //
//                                  algorithm will be employed.                                  //
//      two_hit_window_size.........The window size used by the two-hit BLAST algorithm.  High-  //
//                                  scoring segment pairs on the same diagonal must be within    //
//                                  this window from each other to be extended.  By default,     //
//                                  this value is set to the standard BLAST value of 40          //
//                                  characters.                                                  //
//      expect_threshold............The expect (E-value) threshold for keeping high-scoring      //
//                                  segment pairs.                                               //
//      batch.......................Used to pass multithreading information to functions.  This  //
//                                  value is not intended to be set by the user.                 //
//  If not explicitly set, default values will be used in place of available options.            //
///////////////////////////////////////////////////////////////////////////////////////////////////
// IMPORTS ////////////////////////////////////////////////////////////////////////////////////////
...
function Options() {
    ...
    this.seed.word_size                 =   3;          //  -W  (NCBI BLAST)
...
onmessage = function(e) {
    ...
    switch(job.command) {
        case 'semiglobal': {
            bioAlignment.semiglobal(job.query, job.subject, job.options, job.workerNumber);
            break;
        } // end case
        case 'blastp': {
            bioAlignment.blastp(job.query, job.subject, job.options, job.workerNumber);
            break;
        } // end case
        default: { break; }
    } // end switch
                    ...
                    switch(e.data.command) {
                        case 'semiglobal': {
                            for (let i = 0; i < e.data.result.length; i++) {
                                this.batch.semiglobal.push(e.data.result[i]);
                            } // end if
                            if (this.batch.semiglobal.length >= e.data.result[0].batch) {
                                let result = { status: 'complete', command: 'semiglobal', result: this.batch.semiglobal };
                                postMessage(result);
                                delete this.batch.semiglobal;
                                this.batch.semiglobal = [];
                            } // end if
                        ...
                        case 'blastp': {
                            for (let i = 0; i < e.data.result.length; i++) {
                                this.batch.blastp.push(e.data.result[i]);
                            } // end if
                            if (this.batch.blastp.length >= e.data.result[0].batch) {
                                let result = { status: 'complete', command: 'blastp', result: this.batch.blastp };
                                postMessage(result);
                                delete this.batch.blastp;
                                this.batch.blastp = [];
                            } // end if
                            if (e.data.workerNumber !== 'undefined') {
                                this.workerPool[e.data.workerNumber].inUse = false;
...
//          (a) primary functions associated with the analysis of protein or nucleotide          //
//          sequences, and (b) secondary supporting functions that provide mathematical, and     //
//          string manipulation, and matrix manipulation capabilities.                           //
//===============================================================================================//
//  Functions:                                                                                   //
...
//          filter_hsp_array_by_p_value                                                          //
//          Alignment.flip_string                                                                //
///////////////////////////////////////////////////////////////////////////////////////////////////
// CATEGORY: PRIMARY SINGLE-THREAD FUNCTIONS //////////////////////////////////////////////////////
//  (a) primary functions associated with the analysis of protein or nucleotide sequences.       //
//===============================================================================================//
//  Functions:                                                                                   //
//      Alignment.extend                                                                         //
//      Alignment.seed                                                                           //
...
///////////////////////////////////////////////////////////////////////////////////////////////////
// PROTOTYPE //////////////////////////////////////////////////////////////////////////////////////
Alignment.prototype.evaluate = function(hsp_array, query, subject, options, method) {
    //////////////////////////////////////////////////////////////////////
    ...
    //  and returns one or more sets of consistent HSP.  Multiple       //
    //  strategies are available, and selected through the “method”     //
    //  argument.                                                       //
    //////////////////////////////////////////////////////////////////////
    ...
    switch(method) {
        ...
        case 'genblasta': {
            ...
            //==========================================================//
            //  Reference:                                              //
            //      [1] She, R., Chu, J. S. C., Wang, K., Pei, J., &    //
            //      Chen, N. (2009). GenBlastA: enabling BLAST to       //
            //      identify homologous gene sequences. Genome          //
    ...
    if (hsp_array.length === 1) {
        ...
        report.characters       = query.length;
        report.percent_identity = (report.identity / query.length) * 100;
        let hsp                 = this.copy_attributes(new HSP(), hsp_array[0]);
        hsp.characters          = Math.abs(hsp.query_end - hsp.query_start);
        hsp.percent_identity    = (hsp_array[0].identity / hsp.characters) * 100;
        report.data             = subject;
        report.hsp.push(hsp);
    } // end if (ONE HSP)
    //////////////////////////////////////////////////////////////////////
    // MULTIPLE HSPs /////////////////////////////////////////////////////
        ...
        for (let i = 0; i < hsp_array.length; i++) {
            ...
            hsp.characters       = Math.abs(hsp.query_end - hsp.query_start);
            hsp.percent_identity = (hsp_array[i].identity / hsp.characters) * 100;
...
Alignment.prototype.extend = function(hsp_array, query, subject, options) {
    ...
    //////////////////////////////////////////////////////////////////////
    // UNGAPPED X-DROP ///////////////////////////////////////////////////
    let x_drop_options = this.copy_object(options);
    x_drop_options.score.gapped = false;
    hsp_array = this.x_drop_extend(hsp_array, query, subject, x_drop_options);
    //////////////////////////////////////////////////////////////////////
    // GAPPED X-DROP /////////////////////////////////////////////////////
    if (options.score.gapped) { hsp_array = this.x_drop_extend(hsp_array, query, subject, options); }
    //////////////////////////////////////////////////////////////////////
    // SORT HSPs BY EXPECTED VALUE, LOW TO HIGH //////////////////////////
    hsp_array.sort(function(a, b) {
        if (a.keep && b.keep) {
...
Alignment.prototype.seed = function(query, subject, options) {
    ...
    //  (default 4 characters) between the query and subject sequences. //
    //  If word_exact_match is set to true, then only exact matches     //
    //  are considered.  Otherwise matches will be any subject word     //
    //  that scores at least as high as word_score_threshold when       //
    //  compared to the query sequence, and using the scoring matrix    //
    //  indicated byscore.matrix.  To limit computation time, no more   //
    //  than max_seeds hits will be considered.  However, by default    //
    //  this value is set very large (10 000).  An array of high-       //
    //  scoring segment pairs is returned to the user.                  //
    //==================================================================//
    //  This function examines the following options:                   //
    ...
    //  Note: low-complexity regions are filtered for amino acids using //
    //  the SEG algorithm delevoped by Wootton JC and Federhen S (1993).//
    //  The values used here for the window length (w), trigger         //
    //  complexity (k2_1) and extension complexity (k2_2) are the       //
    //  values suggested by Schäffer AA, et. al (2001).                 //
    //==================================================================//
    //   References:                                                    //
    ...
    while ((query_word_index <= query.length) && (hsp_array.length <= options.seed.max_number)) {
        ...
        if (/[a-z]/.test(query_word)) { query_word_index++; continue; }
        ...
        if ((query_word_score >= options.seed.score_threshold) || options.seed.exact_match) {
            ...
            while ((subject_word_index <= subject.sequence.length) && (hsp_array.length <= options.seed.max_number)) {
                ...
                if (/[a-z]/.test(subject_word)) { subject_word_index++; continue; }
                let word_score = 0;
    ...
    if (!options.score.gapped) {
        for (let i = 0; i < hsp_array.length; i++) {
            if (hsp_array[i].keep) {
                ...
                while ((query_index >= 0) && (subject_index >= 0) && (left_score >= (max_left_score - X1_raw_score)) && (left_score >= 0)) {
                ...
                while ((query_index < query.length) && (subject_index < subject.sequence.length) && (right_score >= (max_right_score - X1_raw_score)) && (right_score >= 0)) {
                    let letter1 = query[query_index];
                    let letter2 = subject.sequence[subject_index];
                ...
                for (let j = 0; j < neighbor.length; j++) {
                    if (!neighbor[j].extended) {
                        if (((neighbor[j].query_start   >= hsp_array[i].query_start  ) && (neighbor[j].query_start   <= hsp_array[i].query_end  )) &&
                            ((neighbor[j].subject_start >= hsp_array[i].subject_start) && (neighbor[j].subject_start <= hsp_array[i].subject_end))) {
                            neighbor[j].keep = false;
                        } // end if
                    } // end if
                } // end for loop
            } // end if
        ...
        hsp_array = this.calculate_hsp_scores(hsp_array, query, subject, options);
        hsp_array = this.filter_hsp_array_by_p_value(hsp_array);
        return hsp_array;
    } // end if
    //////////////////////////////////////////////////////////////////////
    // GAPPED X-DROP /////////////////////////////////////////////////////
...
//  (b) secondary supporting functions that provide mathematical, string manipulation, and       //
...
Alignment.prototype.calculate_hsp_centroids = function(hsp_array, options, method) {
    ...
    switch(method) {
        case 'standard': {
            //////////////////////////////////////////////////////////////
            //  Sets the centroid position to the middle character      //
            //  along the length of each query and subject segments of  //
            //  the HPS (round up if segment consists of an odd number  //
            //  of characters).                                         //
            //////////////////////////////////////////////////////////////
            for (let i = 0; i < hsp_array.length; i++) {
        ...
        case 'x-drop': {
            //////////////////////////////////////////////////////////////
            //  Sets the centroid position for both the query and       //
            //  subject segments as the center position of the highest- //
            //  scoring eleven-character-wide sliding window.           //
            //==========================================================//
            //  References:                                             //
            ...
            //  [2] Zhang, Z., Berman, P., & Miller, W. (1998).         //
            //      Alignments without low-scoring regions. Journal of  //
            //      Computational Biology, 5(2), 197-210.               //
            //////////////////////////////////////////////////////////////
                ...
                if (hsp_array[i].characters < window_length) {
                    ...
                    while ((query_index < hsp_array[i].query.length) && (subject_index < hsp_array[i].subject.length)) {
                        ...
                        for (let j = 0; j < window_length; j++) {
                            ...
                            if (letter1 === letter2) { word_score += options.score.matrix[letter1][letter2]; }
                            if (letter1 === '-') {
        ...
        case 'exonerate': {
            //////////////////////////////////////////////////////////////
            //  Sets the centroid position for both the query and       //
            //  subject segments as the position where one-half of the  //
            //  total alignment score is generated by the remaining     //
            //  alignment to either side.                               //
            //==========================================================//
            //  References:                                             //
            //      [1] Slater, G. S. C., & Birney, E. (2005).          //
            //      Automated generation of heuristics for biological   //
            ...
            for (let i = 0; i < hsp_array.length; i++) {
                ...
                let query_index   = 0;
                let subject_index = 0;
                while ((query_index < hsp_array[i].query_end) && (subject_index < hsp_array[i].subject_end) && (score < mid_score)) {
                    let letter1 = hsp_array[i].query[query_index];
                    let letter2 = hsp_array[i].subject[subject_index];
                    score += options.score.matrix[letter1][letter2];
                    query_index++;
                    subject_index++;
                } // end while loop
...
///////////////////////////////////////////////////////////////////////////////////////////////////
// PROTOTYPE //////////////////////////////////////////////////////////////////////////////////////
Alignment.prototype.filter_hsp_array_by_p_value = function(hsp_array) {
    if (typeof(hsp_array) === 'undefined') { return []; }
    if (!Array.isArray(hsp_array)) { return []; }
    let new_hsp_array = [];
    let threshold = 0.05;
    ...
    for (let i = 0; i < hsp_array.length; i++) { if (hsp_array[i].p_value < threshold) { new_hsp_array.push(hsp_array[i]); } }
    return new_hsp_array
}; // end prototype
///////////////////////////////////////////////////////////////////////////////////////////////////
// PROTOTYPE //////////////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////////////////////////
// PROTOTYPE //////////////////////////////////////////////////////////////////////////////////////
Alignment.prototype.semiglobal = function(query, subject, options, workerNumber) {
    //////////////////////////////////////////////////////////////////////
    // CHECK ARGUMENTS ///////////////////////////////////////////////////
    if (typeof(query  ) === 'undefined') { return []; }
    if (typeof(subject) === 'undefined') { return []; }
    ...
    if (options.multithreading && (subject.length > 1)) {
        for (i = 0; i < subject.length; i++) {
            let job = { status: 'command', command: 'blastp', query: query, subject: [subject[i]], options: options, workerNumber: workerNumber };
            this.add_job(job);
        } // end for loop
    } // end if
    else {
        ...
        for (let index = 0; index < subject.length; index++) {
            let report = new Report(options.batch);
            if (/[a-z]/.test(subject[index].sequence)) {
                subject[index].sequence = subject[index].sequence.toUpperCase();
            } // end if
            //////////////////////////////////////////////////////////////
            // CREATE THE MATRIX /////////////////////////////////////////
            let matrix = this.create_matrix((query.length + 1), (subject[index].sequence.length + 1));
            for (let row = 0; row <= query.length; row++) { matrix[row][0] = { score: 0, direction: 'vertical' }; }
            for (let column = 0; column <= subject[index].sequence.length; column++) { matrix[0][column] = { score: 0, direction: 'horizontal' }; }
            //////////////////////////////////////////////////////////////
            // PERFORM THE ALIGNMENT /////////////////////////////////////
            for (let row = 1; row <= query.length; row++) {
                for (let column = 1; column <= subject[index].sequence.length; column++) {
                    matrix[row][column] = { };
                    matrix[row][column].score = 0;
                    matrix[row][column].direction = 'diagonal';
                    let letter1 = query[(row - 1)];
                    let letter2 = subject[index].sequence[(column - 1)];
                    let diagonal_score   = 0;
                    let horizontal_score = 0;
                    ...
                    // vertical score
                    if (column == subject[index].sequence.length) { vertical_score = matrix[(row - 1)][column].score; }
                    else {
                        if (matrix[(row - 1)][column].direction == 'vertical') { vertical_score = matrix[(row - 1)][column].score - score.gap_extend; }
                        else { vertical_score = matrix[(row - 1)][column].score - (options.score.gap_open + options.score.gap_extend); }
                    } // end else
                    // horizontal score
                    if (row == query.length) { horizontal_score = matrix[row][(column - 1)].score; }
                    else {
                        if (matrix[row][(column - 1)].direction == 'horizontal') { horizontal_score = matrix[row][(column - 1)].score - score.gap_extend; }
            ...
            let column = subject[index].sequence.length;
            report.score     = matrix[row][column].score;
            report.nat_score = (stats.lambda * report.score) - Math.log(stats.k);
            report.bit_score = report.nat_score / Math.log(2);
            report.expect    = stats.k * stats.m_prime * stats.n_prime * Math.exp(-1 * stats.lambda * report.score);
            report.p_value   = 1 - Math.exp(-1 * report.expect);
            report.threshold = 0.05 / subject.length;
            if (report.p_value < report.threshold) { report.significant = true; }
            report.hsp_gaps  = 0;
            report.data      =   subject[index];
            while((row > 0) || (column > 0)) {
                switch(matrix[row][column].direction) {
                    case 'diagonal': {
                        report.query += query[(row - 1)];
                        report.subject += subject[index].sequence[(column - 1)];
                        row--; column--;
                        break;
                    } // end case
                    case 'horizontal': {
            ...
            report.query = this.flip_string(report.query);
            report.subject = this.flip_string(report.subject);
            report_array.push(report);
        } // end for loop
        //////////////////////////////////////////////////////////////////
        let result = { status: 'complete', command: 'semiglobal', result: report_array, workerNumber: workerNumber };
        postMessage(result);
    } // end else
}; // end prototype
///////////////////////////////////////////////////////////////////////////////////////////////////
// PROTOTYPE //////////////////////////////////////////////////////////////////////////////////////
Alignment.prototype.blastp = function(query, subject, options, workerNumber) {
    //////////////////////////////////////////////////////////////////////
    //  This is the "seed-extend-evaluate" algorithm used for protein   //
    //  BLAST searches.  The argument "query" should be supplied as a   //
    //  string.  "subject" may be supplied either as a string, or as an //
    //  array of sequences.  If "subject" is supplied as an array, it   //
    ...
    if (options.multithreading && (subject.length > 1)) {
        ...
        for (index = 0; index < subject.length; index++) {
            ...
            subject[index].sequence.toUpperCase();
            if (!hsp_array.length) {
            ...
            if (options.score.rescale_matrix) {
                options.score.matrix = this.rescale_matrix(query, subject, options);
            } // end if
            ...
            //////////////////////////////////////////////////////////////
            // EVALUATE HSPs /////////////////////////////////////////////
            let report = this.evaluate(hsp_array, query, subject[index], options, 'standard');
            report.batch = options.batch;
            report_array.push(report);
            //////////////////////////////////////////////////////////////
        } // end for loop
        //////////////////////////////////////////////////////////////////
        let result = { status: 'complete', command: 'blastp', result: report_array, workerNumber: workerNumber };
        postMessage(result);
    } // end else
}; // end prototype
///////////////////////////////////////////////////////////////////////////////////////////////////
