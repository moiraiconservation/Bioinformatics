///////////////////////////////////////////////////////////////////////////////////////////////////
// CLIENT_TABLE ///////////////////////////////////////////////////////////////////////////////////
//  This worker script is designed to serve as a wrapper for database table access.  For each    //
//  of this script, a single database table can be either downloaded an stored locally on the    //
//  client's computer, in which case all access is performed on a local array, or the table can  //
//  be accessed on the server, in which case commands are filtered through db_guard.js and       //
//  db_guard.php for secure access.  The script is designed so that either option is             //
//  indistinguishable in terms of script interaction, with the exception of an initial command   //
//  for loading a table locally, and additional commands related to features for structuring and //
//  transforming local tables, which is not possible though MySQL server database queries.  As   //
//  such, the commands recognized by this script can be divided into three categories:           //
//      (1) Commands that can be applied to either client-side or server-side database tables.   //
//      (2) Commands that only can be applied to client-side database tables.                    //
//      (3) Commands that can only be applied to server-side database tables.                    //
///////////////////////////////////////////////////////////////////////////////////////////////////
// IMPORTS ////////////////////////////////////////////////////////////////////////////////////////
